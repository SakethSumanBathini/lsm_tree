...
int main() {
    ...
    std::cout << "  - Small Payload File Size: " << small_file_size / 1024.0 << " KB\n";
    std::cout << "  - Large Payload File Size: " << large_file_size / (1024.0 * 1024.0) << " MB\n\n";
    ...
    // 4. Test Read Performance on Large Payload SSTable
